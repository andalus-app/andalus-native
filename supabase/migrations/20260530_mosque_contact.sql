-- =============================================================================
-- Phase 2C — phone + website on mosques
...
-- submit_mosque gets two extra parameters with DEFAULT NULL so older clients
...
-- ── nearby_mosques: include phone + website ─────────────────────────────────
...
-- ── submit_mosque: accept + store phone & website (default NULL) ────────────
...
BEGIN
  ...
  INSERT INTO mosques (
    ...
    phone, website, image_url, image_storage_path,
    ...
    p_phone, p_website, p_image_url, p_image_storage_path,
